...
var layout = __webpack_require__(4895);
// EXTERNAL MODULE: ./src/components/seo.js
var seo = __webpack_require__(6179);
// EXTERNAL MODULE: ./src/components/Article/ArticleList.tsx + 1 modules
var ArticleList = __webpack_require__(5268);
;// CONCATENATED MODULE: ./src/images/a.png
/* harmony default export */ const a = (__webpack_require__.p + "static/a-58ae8bd9f697f22894f57726248e8768.png");
;// CONCATENATED MODULE: ./src/templates/categories.js
const CategoryTempalte=({data,location,pageContext})=>{var _data$site$siteMetada,_data$site$siteMetada2,_data$site$siteMetada3;const siteTitle=((_data$site$siteMetada=data.site.siteMetadata)===null||_data$site$siteMetada===void 0?void 0:_data$site$siteMetada.title)||`Title`;const siteMenu=((_data$site$siteMetada2=data.site.siteMetadata)===null||_data$site$siteMetada2===void 0?void 0:_data$site$siteMetada2.menu)||[];const description=((_data$site$siteMetada3=data.site.siteMetadata)===null||_data$site$siteMetada3===void 0?void 0:_data$site$siteMetada3.description)||"";const{category,count}=pageContext;const{nodes:posts}=data.allMarkdownRemark;console.log(pageContext);return/*#__PURE__*/index_js_.createElement(layout/* default */.Z,{location:location,title:siteTitle,menu:siteMenu,description:description},/*#__PURE__*/index_js_.createElement(seo/* default */.Z,{title:"All posts"}),/*#__PURE__*/index_js_.createElement("div",{className:"category-page-header"},/*#__PURE__*/index_js_.createElement("div",{className:"category-item"},/*#__PURE__*/index_js_.createElement("div",null,"# ",category.name||category),/*#__PURE__*/index_js_.createElement("div",null,count))),/*#__PURE__*/index_js_.createElement("div",{className:"category-page-body"},/*#__PURE__*/index_js_.createElement(ArticleList/* ArticleList */.w,{posts:posts})));};/* harmony default export */ const categories = (CategoryTempalte);const pageQuery="1753545718";

/***/ })

};
;
//# sourceMappingURL=component---src-templates-categories-js.js.map