    ...
    <li className="mt-6">
      ...
      >
        <a
          href={href}
          itemProp="url"
          className="block text-[1.125rem] font-semibold py-3"
        >
          ...
          before:rounded-2xl before:block before:mr-1 before:w-2 before:h-2"
            ...
            <div
              className="bg-red-300 rounded-full text-[white] fill-[white] text-[0] opacity-0 p-1 scale-50 transition-all -rotate-[135deg]
          ...
          <span
            itemProp="headline"
            className="bg-green-400 block text-[1.125rem] font-semibold group-hover:underline"
          >
            {title}
          </span>
