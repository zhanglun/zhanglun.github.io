...
![Untitled.png](./images/480b8e62599f2d2e.png)


 同时，对`package.json`也有修改，除了增加Storybook需要的依赖之外，还增加了两个script命令，用于启动开发服务器和打包文档


![Untitled.png](./images/f6c89db6a067d2e3.png)
...
![Untitled.png](./images/4302baf7ca84fab6.png)


![Untitled.png](./images/8f7adcdca64a3a6a.png)
...
![Untitled.png](./images/575d4d44b627a320.png)
