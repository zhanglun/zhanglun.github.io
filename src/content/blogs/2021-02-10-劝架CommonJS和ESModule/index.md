...
具体的标准可以参考 [ECMAScript Modules](https://tc39.es/ecma262/#sec-modules)
...
在 ES6 提出了 ESModule 作为语言标准以后，JavaScript这门语言终于有了自己的模块化方案了，具体的标准可参考[ECMAScript Modules](https://tc39.es/ecma262/#sec-modules)。
...
1. 将模块顶部的变量作用域（比如： var, const或者let)限制在模块中，而不是全局对象global
2. 提供了一些指向当前模块的，看起来像是全局的变量
    1. module 和 exports ，可以导出模块中的值
    2. __filename是模块的绝对路径，__dirname是模块文件所在的文件夹路径
