...
![Untitled.png](./images/33add13481e3dfa1.png)
...
![Untitled.png](./images/2076c3b8e5fb38cd.png)


SVG本身也有一些不错的优势，简单列举了几点，更多的优势和细节就不在此赘述了。

1. 天生的可伸缩性，适合做图标
2. 文本文件，设计工具和文本编辑器都可以编辑
3. 纯粹的 XML，嵌入页面不需要编码
...
![Untitled.png](./images/ed8db7efd447b93c.png)
...
![Untitled.png](./images/8ef92dd523f9b24e.png)


如果能够把SVG都转换成对应的组件，然后维护起来，弄个像模像样的页面，咱们的图标系统是不是就算是搭建起来了？按照这个思路，先来捋一捋流程。


![Untitled.png](./images/be5c67a0cd48f091.png)
...
![Untitled.png](./images/3153fea56fdc3d7f.png)
