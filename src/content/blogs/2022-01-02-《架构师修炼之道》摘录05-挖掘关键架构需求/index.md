...
![Untitled.png](./images/2c190dffa86f25e4.png)
...
![Untitled.png](./images/5cb43e4911bfbbf3.png)
...
2. 对功能需求进行大致分类，每类需求反映一个相同类型的架构问题。
3. 对照概念架构草图，思考每个分类如何实现。如果对于己知的粗粒度需求，实现功能的方式并不明显，那么它就可能对架构有重大影响。
...
![Untitled.png](./images/03b8701a89d05f72.png)
...
![ASR 工作簿大纲](./images/e23056cc6141e3a5.png)
