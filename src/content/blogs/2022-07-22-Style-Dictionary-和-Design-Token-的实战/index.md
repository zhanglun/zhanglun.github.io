...
![Untitled.png](./images/de341c138a38d87c.png)
...
1. 全局token提供了一系列来自基础色板的颜色token，比如`palette-brand-blue-500`。
2. 在它的基础上使用别名`semantic-brand-color-default`让token语义化。
3. 主按钮的背景色的Token是 `button-color-primary-normal-default-background`，次级按钮的背景色的Token是 `button-color-secondary-normal-default-background` 。

最后设计师交付给开发的Token文件通过git托管在内部仓库中，其包含的内容如下图所示


![Untitled.png](./images/887c02fee61598c7.png)
...
1. sizing的value加上单位px
2. spacing的value需要转换成客户端能够识别的语法，可以是计算之后的具体值，也可以是`calc()`。
...
1. 注册一个Transform。matcher用来过滤token，在transformer中实现核心转换逻辑。
...
1. 将 Tranform 加入到 TranformGroup 。
...
1. 修改 config，将`platforms.css.transformGroup` 设置为注册的TransformGroup的名字
...
![Untitled.png](./images/bd84b3f768b3de48.png)


Adobe 的 Spectrum


![Untitled.png](./images/6764664bb5bb388a.png)
...
![Untitled.png](./images/5d41f06fbea972a1.png)


转换为


![Untitled.png](./images/6f6b9ae5b539d201.png)
...
![Untitled.png](./images/d9fa6e0f56e45e9c.png)


![Untitled.png](./images/fcbe9d4ac485db02.png)


![Untitled.png](./images/ffd71437af289dfd.png)
