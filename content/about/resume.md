...
1. 参与日常开发和业务需求支撑；作为B端**需求对接人**，拆解任务，协调前端人力。
...
1. 参与平台门户架构设计。负责了包括门户首页，服务市场，文档中心和问答等多个模块，**基于Node.js的全栈开发**。
...
1. **从零到一**完成了整个项目，包括项目脚手架的搭建，构建打包流程，Web前端单页应用的开发，Node层的数据聚合和操作记录等业务逻辑。
2. 产出基于 Node.js 的Web项目的私有化部署方案，具备一键构建和一键部署的能力。
...
2. 主导团队**UI组件库**的落地和维护，服务于20+PaaS服务系统。
